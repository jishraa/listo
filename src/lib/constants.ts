...
export const LIST_CATEGORIES: Record<ListType, ListCategory[]> = {
  shopping: [
    { id: 'produce',   name: 'Produce',       color: '#1D9E75',
    ...
    { id: 'frozen',    name: 'Frozen',        color: '#3B82F6',
      keywords: ['frozen','ice cream','icecream','popsicle'] },
    { id: 'beverages', name: 'Beverages',     color: '#F59E0B',
  ...
  tasks: [
    ...
    { id: 'home',     name: 'Home',     color: '#1D9E75',
  ...
  personal: [
    ...
    { id: 'notes',   name: 'Notes',   color: '#3B82F6',
      keywords: ['note','reminder','memo','log','journal'] },
    { id: 'wishes',  name: 'Wishes',  color: '#EC4899',
...
export function detectCategory(text: string, type: ListType): string | null {
  ...
  for (const cat of LIST_CATEGORIES[type]) {
