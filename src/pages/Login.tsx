            ...
            <form className="auth-form" noValidate onSubmit={e => { e.preventDefault(); handleSubmit() }}>
              ...
              {mode !== 'forgot' && (
                <>
                  ...
                  {/* Apple sign-in disabled 2026-07 (user request). NOTE: App
                      Store guideline 4.8 requires Apple wherever other social
                      logins are offered — restore it before an iOS release. */}
